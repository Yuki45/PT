                ...
                if (!ctrlStat)
                {
                    for (int i = 0; i < StatusJIG.Length; i++)
                    {
                        if (i == 1)
                        {
                            try
                            {
                                if (StatusJIG.Substring(0, 2) == "00")
                                    Jig1 = "A0";
                                else if (StatusJIG.Substring(0, 2) == "01")
                                    Jig1 = "A1";
                            }
                            catch
                            {
                        ...
                        if (i == 3)
                        {
                            try
                            {
                                if (StatusJIG.Substring(2, 2) == "10")
                                    Jig2 = "B0";
                                else if (StatusJIG.Substring(2, 2) == "11")
                                    Jig2 = "B1";
                            }
                            catch
                            {
        ...
        public string Jig1
        {
            ...
            set
            {
                ...
                else if (value == "A0")
                {
                    ...
                    lvi1.Name = "item1";
                    if (!IsInCollection(lvi1) && !sjig1 && !sPort1 && SnJig1.BackColor != Color.Green)
                    {
                        sjig1 = true;
                        listView1.Items.Add(lvi1);
                    }
                    SnJig1.BackColor = Color.Green;
                }
        ...
        public string Jig2
        {
            ...
            set
            {
                ...
                else if (value == "B0")
                {
                    ListViewItem lvi1 = new ListViewItem(value);
                    lvi1.Name = "item1";
                    if (!IsInCollection(lvi1) && !sjig2 && !sPort2 && SnJig2.BackColor != Color.Green)
                    {
                        sjig2 = true;
                        listView1.Items.Add(lvi1);
                    }
                    SnJig2.BackColor = Color.Green;
                }
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (status == 1 && !gbConfig.Enabled)
            {
                ...
                if (listView1.Items.Count > 0)
                {
                    ...
                    if (listView1.Items[0].SubItems[0].Text == "A0")
                                {
                                    if (!MoveStatus)
                                    {
