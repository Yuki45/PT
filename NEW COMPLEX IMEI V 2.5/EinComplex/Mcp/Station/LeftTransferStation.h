#ifndef __LEFTTRANSFERSTATION_H__
#define __LEFTTRANSFERSTATION_H__
...
class CLeftNGCVStation;
class CMainFrame;
class CLeftTransferStation : public CAxStation
{
public:
	enum AutoState 
	{
	...
	CLeftTransferStation();
	virtual ~CLeftTransferStation();
	...
	CLeftNGCVStation* m_pLeftNGCVStn;
