...
namespace Auto_Scanner_EPASS
{
    public partial class MainForm : Form
    {
        ...
        private void config2()
        {
            ...
            {
                gmes2.Close();
                gmes2.PortName = txtGMES2.Text;
                gmes2.BaudRate = 9600;
                gmes2.DataBits = 8;
                gmes2.Parity = Parity.None;
                gmes2.StopBits = StopBits.One;
                gmes2.Open();
                this.gmes2.DataReceived += new System.IO.Ports.SerialDataReceivedEventHandler(this.GMES2_DataReceived);
                txtGMES2.BackColor = Color.Chartreuse;
            }
            catch
            {
                txtGMES2.BackColor = Color.Red;
            }
        ...
        private void GMES2_DataReceived(object sender, SerialDataReceivedEventArgs e)
        {
            string data = gmes.ReadExisting();
            ...
            if (nmBarcode.Value == 3)
            {
                if (txtsn1.Text != "" && txtsn2.Text != "" && txtsn3.Text != "")
                {
                    try
                    {
                        ...
                        {
                            gmes2.Write((char)2 + txtsn1.Text + (char)3);
                            Thread.Sleep(200);
                            gmes2.Write((char)2 + txtsn2.Text + (char)3);
                            Thread.Sleep(200);
                            gmes2.Write((char)2 + txtsn3.Text + (char)3);
                            Comstatus = "GMES1";
                        }
                    }
                    catch (Exception ex)
