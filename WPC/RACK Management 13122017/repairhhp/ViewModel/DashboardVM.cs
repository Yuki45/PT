...
namespace repairhhp.ViewModel
{
    ...
    {   
        public DashboardVM()
        {
            ...
            this.LoadRackGRCommand = new DelegateCommand(o => this.LoadRackGR());
            this.LoadRackGICommand = new DelegateCommand(o => this.LoadRackGI());
            this.LoadRackDashboardCommand = new DelegateCommand(o => this.LoadRackDashboard());
            this.LoadRackHistoryCommand = new DelegateCommand(o => this.LoadRackHistory());
        }
        ...
        public ICommand LoadRackGRCommand { get; private set; }
        public ICommand LoadRackGICommand { get; private set; }
        public ICommand LoadRackDashboardCommand { get; private set; }
        public ICommand LoadRackHistoryCommand { get; private set; }
        ...
        private void LoadRackGR()
        {
            CurrentViewModel = new RackGRVM(
                new Models.RackGR() { PageTitle = "Rack GR " });
        }

        private void LoadRackGI()
        {
            CurrentViewModel = new RackGIVM(
                new Models.RackGI() { PageTitle = "Rack GI " });
        }

        private void LoadRackDashboard()
        {
            CurrentViewModel = new RackDashboardVM(
                new Models.RackDashboard() { PageTitle = "Rack Dashboard " });
        }

        private void LoadRackHistory()
        {
            CurrentViewModel = new RackHistoryVM(
                new Models.RackHistory() { PageTitle = "Rack Dashboard " });
        }
    }
}
